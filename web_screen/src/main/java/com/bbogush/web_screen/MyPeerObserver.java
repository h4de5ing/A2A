...
class MyPeerObserver implements PeerConnection.Observer {
    private String logTag = "WebRtcManager";
    ...
    public void onConnectionChange(PeerConnection.PeerConnectionState newState) {
        ...
        Log.d(logTag, "onConnectionChange() called with: newState = [" + newState + "]");
    }
