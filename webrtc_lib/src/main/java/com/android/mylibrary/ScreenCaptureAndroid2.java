 ...
 */
public class ScreenCaptureAndroid2 implements VideoCapturer, VideoSink {
     ...
     **/
    public ScreenCaptureAndroid2(Intent mediaProjectionPermissionResultData,
    ...
    public synchronized void startCapture(
        ...
        surfaceTextureHelper.startListening(ScreenCaptureAndroid2.this);
    }
    ...
    public void onFrame(VideoFrame frame) {
        ...
        frameChangeListener.onFrameChanged(frame);
//        Log.i("MainActivity2", "onFrame " + numCapturedFrames);
    }
