...
public class ScreenEncoder2 implements Device.RotationListener {
    ...
    public ScreenEncoder2(int bitRate, int frameRate, int iFrameInterval) {
        this.bitRate = bitRate;
        this.frameRate = frameRate;
        this.iFrameInterval = iFrameInterval;
    }

    public ScreenEncoder2(int bitRate) {
    ...
    public void streamScreen(Device device, DataChangeListener dataChangeListener) throws IOException {
...
//        outputStream.write(array, 0, array.length);   // Sending device resolution
        ...
        try {
            do {
                ...
                codec.start();
                try {
                    alive = encode(codec, dataChangeListener);
                } finally {
                    codec.stop();
    ...
    private boolean encode(MediaCodec codec, DataChangeListener dataChangeListener) throws IOException {
            ...
            try {
                ...
                if (outputBufferId >= 0) {
                    ...
                    if (bufferInfo.size > 0 && outputBuffer != null) {
                        ...
                        dataChangeListener.onDataChanged(packet.toByteArray());
                    }
                }
            } finally {
                if (outputBufferId >= 0) {
